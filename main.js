...
/***/ "./src/scripts/detectWebAudio.js":
/*!***************************************!*\
  !*** ./src/scripts/detectWebAudio.js ***!
  \***************************************/
/*! exports provided: detectAudioContext, detectGetUserMedia, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "detectAudioContext", function() { return detectAudioContext; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "detectGetUserMedia", function() { return detectGetUserMedia; });
var detectAudioContext = function detectAudioContext() {
...
var detectGetUserMedia = function detectGetUserMedia() {
	navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia;

	if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia || navigator.getUserMedia) return navigator.mediaDevices && navigator.mediaDevices.getUserMedia ? navigator.mediaDevices.getUserMedia.bind(navigator.mediaDevices) : function (constraints) {
...
var WebAudio = {
	detectAudioContext: detectAudioContext,
	detectGetUserMedia: detectGetUserMedia
};
...
/* harmony import */ var _detectWebAudio__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detectWebAudio */ "./src/scripts/detectWebAudio.js");
/* harmony import */ var _autoCorrelate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./autoCorrelate */ "./src/scripts/autoCorrelate.js");
/* harmony import */ var _assets_notes_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/notes.json */ "./src/assets/notes.json");
var _assets_notes_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../assets/notes.json */ "./src/assets/notes.json", 1);
...
var audioCtx = Object(_detectWebAudio__WEBPACK_IMPORTED_MODULE_1__["detectAudioContext"])();
var getUserMedia = Object(_detectWebAudio__WEBPACK_IMPORTED_MODULE_1__["detectGetUserMedia"])();

var frequencyTable = _assets_notes_json__WEBPACK_IMPORTED_MODULE_3__;
var baseFrequency = 440; // A default frequency ot start with
var currentNoteIndex = 57; // 57 is the A4 in the notes array
var notesArray = frequencyTable[baseFrequency]; // Select a frequency table based on the frequency

// Predefine variables
var audioSource = void 0;
var audioAnalyser = void 0;
var microphoneStream = void 0;

// Get elements from page
var aNote = document.getElementById('a-note');
var aFrequency = document.getElementById('a-frequency');
var aCents = document.getElementById('a-cents');
...
if (audioCtx) {
	...
	if (getUserMedia) {
		...
		getUserMedia({ audio: true }).then(streamReceived).catch(handleError);
	} else {
...
//
function detectNote() {
	var buffer = new Uint8Array(audioAnalyser.fftSize); //
	audioAnalyser.getByteTimeDomainData(buffer);

	var fundamentalFrequency = Object(_autoCorrelate__WEBPACK_IMPORTED_MODULE_2__["findFundamentalFrequency"])(buffer, audioCtx.sampleRate);

	if (fundamentalFrequency !== -1) {
		var note = Object(_autoCorrelate__WEBPACK_IMPORTED_MODULE_2__["findClosestNote"])(fundamentalFrequency, notesArray);
		var cents = Object(_autoCorrelate__WEBPACK_IMPORTED_MODULE_2__["findCentsOffPitch"])(fundamentalFrequency, note.frequency);
...
function changeBaseFrequency(delta) {
	var newBaseFrequency = baseFrequency + delta;
